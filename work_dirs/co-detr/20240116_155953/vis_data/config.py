...
batch_size = 4
custom_hooks = [
    dict(test_out_dir='submit', type='SubmissionHook'),
]
custom_imports = dict(
...
test_evaluator = dict(
    _scope_='mmdet',
    ann_file='/data/ephemeral/home/datasettest.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
...
train_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='fold_1/stratified_train.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root='/data/ephemeral/home/dataset',
...
val_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        ann_file='fold_1/stratified_val.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root='/data/ephemeral/home/dataset',
        metainfo=dict(
...
val_evaluator = dict(
    _scope_='mmdet',
    ann_file='/data/ephemeral/home/datasetfold_1/stratified_val.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric='bbox',
